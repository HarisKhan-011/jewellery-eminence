              ...
              <div className="row align-items-end">
                <div className="col-md-4 col-sm-6">
                  <div className="invoice__left">
                    <Logo className="eminence-logo--invoice mb-15" priority sizes="190px" />
                    <p>
          ...
          <Tbody className="table-group-divider">
            {cart.map((item, i) => (
              <Tr key={i}>
                ...
                <Td>
                  {formatPkrAmount(
                    getDiscountedPkrPrice(item.originalPrice, item.discount)
                  )}
                </Td>
                <Td>
                  {formatPkrAmount(
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-4">
            <div className="invoice__shippint-cost mb-30">
              ...
              <p className="tp-font-medium">{formatPkrAmount(shippingCost)}</p>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="invoice__discount-cost mb-30">
              <h5 className="mb-0">Discount</h5>
              <p className="tp-font-medium">{formatPkrAmount(discount)}</p>
            </div>
          </div>
          <div className="col-lg-3 col-md-4">
            <div className="invoice__total-ammount mb-30">
              ...
              <p className="tp-font-medium text-danger">
                <strong>{formatPkrAmount(totalAmount)}</strong>
              </p>
            </div>
          </div>
        </div>
